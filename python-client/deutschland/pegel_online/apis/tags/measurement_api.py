...
from deutschland.pegel_online.paths.stations_station_timeseries_measurements_json.get import (
    GetMeasurementByStation,
)
from deutschland.pegel_online.paths.stations_station_timeseries_measurements_png.get import (
