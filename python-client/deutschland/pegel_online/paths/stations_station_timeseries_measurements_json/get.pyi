...
from pegel_online import api_client, exceptions
from pegel_online.model.measurement_result import MeasurementResult
from pegel_online.model.timeseries_not_found import TimeseriesNotFound
...
SchemaFor200ResponseBodyApplicationJson = MeasurementResult
SchemaFor404ResponseBodyApplicationJson = TimeseriesNotFound
_all_accept_content_types = ("application/json",)

class BaseApi(api_client.Api):
    def _get_measurement_by_station_oapg(
        self: api_client.Api,
...
class GetMeasurementByStation(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def get_measurement_by_station(
        self: BaseApi,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        ...
        return self._get_measurement_by_station_oapg(
