...
StationsSchema = schemas.StrSchema
IncludeStationsSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    "RequestOptionalQueryParams",
    {
        ...
        "stations": typing.Union[
            StationsSchema,
            str,
        ],
        "includeStations": typing.Union[
...
request_query_stations = api_client.QueryParameter(
    name="stations",
    style=api_client.ParameterStyle.FORM,
    schema=StationsSchema,
    explode=True,
)
request_query_include_stations = api_client.QueryParameter(
    name="includeStations",
    style=api_client.ParameterStyle.FORM,
    schema=IncludeStationsSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = WaterResult
...
class BaseApi(api_client.Api):
    def _get_waters_oapg(
        ...
        for parameter in (
            request_query_ids,
            request_query_stations,
            request_query_include_stations,
