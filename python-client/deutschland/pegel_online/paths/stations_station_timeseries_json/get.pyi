...
SchemaFor200ResponseBodyApplicationJson = Timeseries
SchemaFor404ResponseBodyApplicationJson = TimeseriesNotFound
_all_accept_content_types = ("application/json",)

class BaseApi(api_client.Api):
    def _get_current_measurment_by_station_oapg(
        self: api_client.Api,
...
class GetCurrentMeasurmentByStation(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def get_current_measurment_by_station(
        self: BaseApi,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        ...
        return self._get_current_measurment_by_station_oapg(
