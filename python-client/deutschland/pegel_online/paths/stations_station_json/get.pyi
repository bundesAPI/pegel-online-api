...
SchemaFor200ResponseBodyApplicationJson = Station
_all_accept_content_types = ("application/json",)

class BaseApi(api_client.Api):
    def _get_stations_by_id_oapg(
        self: api_client.Api,
        ...
        _path_params = {}
        for parameter in (request_path_station,):
...
class GetStationsById(BaseApi):
    ...
    def get_stations_by_id(
        ...
        return self._get_stations_by_id_oapg(
