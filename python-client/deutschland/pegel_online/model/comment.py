...
class Comment(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]): Liegt z.B. eine Fehlfunktion oder ein Ausfall an der Messstelle vor, so ist dies hier mit einer Textbeschreibung erläutert..  # noqa: E501

        Keyword Args:
            value ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]): Liegt z.B. eine Fehlfunktion oder ein Ausfall an der Messstelle vor, so ist dies hier mit einer Textbeschreibung erläutert..  # noqa: E501
